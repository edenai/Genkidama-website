// Shared noise chunk. Prepended to shaders that need it.
...
// Cheap divergence-free-ish flow field built from three noise samples.
vec3 curl(vec3 p) {
  float e = 0.35;
  ...
  return vec3(n1 - n2 - (n3 - n4), n3 - n4 - (n5 - n6), n5 - n6 - (n1 - n2)) / (2.0 * e);
}
